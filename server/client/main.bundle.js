...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_14__shared_product_service__["a" /* ProductService */], __WEBPACK_IMPORTED_MODULE_16__shared_web_socket_service__["a" /* WebSocketService */], { provide: __WEBPACK_IMPORTED_MODULE_17__angular_common__["a" /* LocationStrategy */], useClass: __WEBPACK_IMPORTED_MODULE_17__angular_common__["b" /* HashLocationStrategy */] }],
...
module.exports = "<div class=\"container\">\n  <hr>\n  <footer>\n    <div class = \"row\">\n      <div class = \"col-lg-12\">\n        <p>Auction for your ideal products.</p>\n      </div>\n    </div>\n  </footer>\n</div>\n"
...
module.exports = "<form [formGroup] = \"formModel\" (ngSubmit)=\"onSearch()\" novalidate>\n  <div class=\"form-group\" [class.has-error]=\"formModel.hasError('minlength', 'title')\">\n    <label for=\"productTitle\">Name:</label>\n    <input formControlName=\"title\" type=\"text\" id=\"productTitle\" placeholder=\"Name\" class=\"form-control\">\n    <span class=\"help-block\" [class.hidden]=\"!formModel.hasError('minlength', 'title')\">\n      Please enter a least 3 letters.\n    </span>\n  </div>\n\n  <div class=\"form-group\" [class.has-error]=\"formModel.hasError('posNum','price')\">\n    <label for=\"productPrice\">Price:</label>\n    <input formControlName=\"price\" type=\"text\" id=\"productPrice\" placeholder=\"Price\" class=\"form-control\">\n    <span class=\"help-block\" [class.hidden]=\"!formModel.hasError('posNum','price')\">\n      Price must be a positive number.\n    </span>\n  </div>\n\n  <div class=\"form-group\">\n    <label for=\"productCategory\">Category:</label>\n    <select formControlName=\"category\" id=\"productCategory\" class=\"form-control\">\n      <option value=\"-1\">All Categories</option>\n      <option *ngFor=\"let category of categories\" [value]=\"category\">{{category}}</option>\n    </select>\n  </div>\n\n  <div class=\"form-group\">\n    <button type=\"submit\" class=\"btn btn-primary btn-block\">Go!</button>\n  </div>\n</form>\n"
...
var SearchComponent = (function () {
    ...
    SearchComponent.prototype.posNumValidator = function (control) {
        if (!control.value)
            return null;
...
var ProductService = (function () {
    ...
    ProductService.prototype.search = function (params) {
        ...
        var myParams = this.encodeParams(params);
        var options = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* RequestOptions */]({ headers: myHeaders, params: myParams });
        return this.http.get("/api/products", options).map(function (res) { return res.json(); });
    };
